...
public class PlayerActionInfoConstant {
    ...
    public static final int PAUSE_MESSAGE = 5;
    public static final int RESUME_MESSAGE = 6;
    public static final int BUFFER_START = 7;
    public static final int BUFFER_END = 8;
    public static final int PLAYABE_REPORT = 9;
    public static final int BITRATE_CHANGE = 10;
    public static final int PLAY_QUIT = 11;
